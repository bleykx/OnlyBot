...
namespace OnlyBot.Controllers
{
    ...
    public class ScriptController : ControllerBase
    {
        ...
        [HttpPost("filteredscripts")]
        public async Task<IActionResult> Filter([FromBody] Dictionary<string, List<string>> filters)
        {
            var filteredScripts = await _scriptRepository.GetFilteredScripts(filters);

            return Ok(filteredScripts);
        }
    }
}
